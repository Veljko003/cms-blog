    ...
    <section class="container py-2 mb-4">
      <div class="row" style="min-height:30px;">
        <div class="col-lg-12" style="min-height:400px;">
          ...
          <?php
          global $ConnectingDB;
          // Affichage des commentaires désapprouvés
          $sql = "SELECT `id`, `datetime`, `name`, `comment`, `post_id`  FROM `comments` WHERE `status`='OFF'";
          ...
          $sql = "SELECT `id`, `datetime`, `name`, `approvedby`, `comment`, `post_id` FROM `comments` WHERE `status`='ON'";
          $Execute =$ConnectingDB->query($sql);
          $SrNo = 0;
          while ($DataRows=$Execute->fetch()) {
            $CommentId         = $DataRows["id"];
