...
if(isset($_POST["Submit"])){
  ...
  if(empty($Name)||empty($Email)||empty($Comment)){
    ...
    $sql  = "INSERT INTO `comments`(`datetime`, `name`, `email`, `comment`, `post_id`) VALUES (:dateTime, :name, :email, :comment, :postIdFromURL)";
    $sql .= "";
      ...
      <div class="row mt-4">
        ...
        <div class="col-sm-8 ">
          ...
          // The default SQL query
            ...
            //** Ajouter une requête SQL ici **//
            $sql  = "SELECT * FROM `posts` WHERE '$PostIdFromURL'";
        ...
        <?php
        global $ConnectingDB;
        // Séléction des commentaires par rapport au $PostIdFromURL
        $sql  = "SELECT `datetime`, `name`, `comment` FROM `comments` WHERE '$PostIdFromURL'";
        $stmt =$ConnectingDB->query($sql);
        while ($DataRows = $stmt->fetch()) {
