...
if(isset($_POST["Submit"])){
  ...
  if(empty($PostTitle)){
    ...
    if (!empty($_FILES["Image"]["name"])) {
      // Mettre à jour le post séléctionné avec $SearchQueryParameter avec des valeurs, inclus l'image et le nom
      $sql = "UPDATE `posts`(`title`, `category`, `image`, `post`, `author`) SET ('$PostTitle', '$Category', '$Image', '$PostText', '$Admin') WHERE '$SarchQueryParameter'";
    }else {
      // Mettre à jour le post séléctionné avec $SearchQueryParameter avec des valeurs, exclus l'image et le nom
      $sql = "UPDATE `posts`(`title`, `category`, `post`, `author`) SET ('$PostTitle', '$Category', '$PostText', '$Admin') WHERE '$SarchQueryParameter'";
    }
