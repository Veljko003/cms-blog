      ...
      <div class="row mt-4">
        ...
        <div class="col-sm-8 ">
          ...
          if(isset($_GET["SearchButton"])){
            $Search = $_GET["Search"];
            // Afficher tout qui correspond à valeur dans search
            $sql = "SELECT * FROM `posts` WHERE :search ";
          ...
          elseif (isset($_GET["page"])) {
            ...
            $sql ="SELECT * FROM `posts` WHERE '$Page'";
          ...
          <nav>
            ...
            $sql           = "SELECT * FROM `posts` WHERE '$Page - 1'";
            $stmt          = $ConnectingDB->query($sql);
        ...
        <div class="col-sm-4">
          ...
          <div class="card">
            <div class="card-header bg-primary text-light">
              ...
              <div class="card-body">
                <?php
                global $ConnectingDB;
                // Séléction des catégories par rapport aux valeurs $CategoryId et $CategoryName
                $sql = "SELECT `id`, `title` FROM `category` WHERE '$CategoryId', '$CategoryName'";
                $stmt = $ConnectingDB->query($sql);
                while ($DataRows = $stmt->fetch()) {
          ...
          <div class="card">
            ...
            <div class="card-body">
              <?php
              global $ConnectingDB;
              // Séléction des posts récent trié par datetime descendant
              $sql= "SELECT `id`, `title`, `datetime`, `image` FROM `posts` ORDER BY `datetime` DESC";
              $stmt= $ConnectingDB->query($sql);
              while ($DataRows=$stmt->fetch()) {
                $Id     = $DataRows['id'];
